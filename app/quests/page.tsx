...
const quests = [
  ...
  {
    id: "memegif-studio",
    title: "The MemeGif Studio Saga",
    type: "Main Quest",
    status: "Completed",
    difficulty: "Legendary",
    description:
      "MemeGif Studio is an AI-powered web application that converts video clips into captioned GIFs using OpenAI and FFmpeg. Built a full-stack application with seamless user interaction, automatic speech-to-text transcription, and optimized GIF generation performance.",
    technologies: [
      "React.js",
      "Node.js",
      "Express.js",
    ...
    experience: 3200,
    rewards: ["AI Integration Master", "Video Processing Expert", "OpenAI API Specialist", "File Handling Wizard"],
    ...
    challenges: [
      "Integrating OpenAI Whisper API for speech-to-text transcription",
      "Implementing efficient file handling with Multer for large uploads (100MB+)",
      "Optimizing FFmpeg for high-performance GIF generation",
      "Creating contextual GIF captions from video content using AI",
    ],
  },
  {
